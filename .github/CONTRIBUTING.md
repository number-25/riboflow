# riboflow: Contributing Guidelines

Hi there!
Many thanks for taking an interest in improving riboflow.

We try to manage the required tasks for riboflow using GitHub issues, you probably came to this page when creating one.
...
To make the riboflow code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
...
- Open the repo in [Codespaces](https://github.com/number-25/riboflow/codespaces)
- Tools installed
  - nf-core
  - Nextflow
